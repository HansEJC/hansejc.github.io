...
<html>
	<head>
		...
		<title>Calculation and Plotting Tools</title>
		...
		<script src="js/trex.js?=v1.1"></script>
		<script src="js/scores.js?=v1.5"></script>
		...
		<!-- Header -->
			<div id="header-wrapper" class="wrapper">
				<div id="header">
					<!-- Logo -->
						<div id="logo">
							<h1><a href="#">Calculation and Plotting Tools</a></h1><br>							
						</div>	
						<!-- Nav -->
					<nav id="nav">
						<ul>
							<li class="current">
								...
								<ul>
									<li><a href="mole.php">Mole Game</a></li>									
								</ul>
							</li>
							<li>
								<a href="#">Tools</a>
								...
								<div id="content">
									...
									<div class="row 50%">
												...
												<section class="post"><br>
													<center>
														Ajuden al noob sobrevivir. Press spacebar to start.
													</center>
													<input type=checkbox id=0 onchange="mods();">
													<label for="0"> God Mode</label><br>
													<input type=checkbox id=1 onchange="cheats();">
													<label for="1"> Triple Jump</label>													
													<br><b><span id="TempScore"></span></b>
												</section>
												<!--
		<div class="et_pb_code_inner"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d42095.300515157694!2d-2.441692658942694!3d53.093426138931044!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x487a5f3f3cc3321f%3A0x797b79a151576fc2!2sPower+Supply+Projects+Ltd!5e0!3m2!1sen!2suk!4v1558090197149!5m2!1sen!2suk" 
		width="600" height="635" frameborder="0" style="border:0" allowfullscreen></iframe></div>-->
